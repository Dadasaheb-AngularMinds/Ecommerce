  ...
  return (
    <div class="h-screen overflow-x-auto  no-scrollbar mx-10">
      ...
      <div className="grid grid-cols-1 gap-2 mt-5 sm:grid-cols-2">
        <div className="">
          <input
            className="w-1/2 py-3 pl-10 pr-4 border rounded-lg md:w-1/2 sm:w-1/3 focus:outline-orange-400 "
            placeholder="Coupon code..."
          />
          <button className="px-5 py-3 ml-3 transition-all duration-300 bg-orange-400 border border-orange-300 rounded-md hover:bg-orange-300">
            Apply coupon
          </button>
        </div>
        <div className="space-y-2">
          ...
          <button className="px-5 py-3 transition-all duration-300 bg-orange-400 border border-orange-300 rounded-md hover:bg-orange-300">
            Proceed to Checkout
          </button>
        </div>
      </div>
