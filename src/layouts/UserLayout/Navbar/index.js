    ...
    <div className="grid h-20 grid-cols-1 bg-[#ffffff]  sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5">
      ...
      <div className="hidden py-0 my-3 sm:hidden lg:block md:hidden xl:block">
        <div className="flex flex-row py-2 group">
          <div className="relative w-1/4 h-full ">
            <i
              className="absolute fa fa-retweet text-orange-400 text-4xl top-1 group-hover:-top-1 transition-all duration-300 left-1/4"
              aria-hidden="true"
            ></i>
          </div>
          <div className="cursor-pointer">
      ...
      <div className="justify-center hidden py-0 my-3 md:justify-end sm:hidden lg:block md:block xl:block">
        <div className="flex flex-row justify-center gap-4 py-2 group">
          <i
            className="fa fa-user-circle-o text-gray-800 cursor-pointer hover:text-orange-500 hover:animate-spin text-2xl group-hover:top-0 transition-all duration-300 left-1/4"
            aria-hidden="true"
          ></i>
          <i
            className="fa fa-random text-gray-800 cursor-pointer hover:text-orange-500 hover:animate-pulse text-2xl group-hover:top-0 transition-all duration-300 left-1/4"
            aria-hidden="true"
          ></i>
          <i
            className="fa fa-heart-o text-gray-800 cursor-pointer hover:text-orange-500 hover:animate-pulse text-2xl group-hover:top-0 transition-all duration-300 left-1/4"
            aria-hidden="true"
          ></i>
          <i
            className="fa fa-shopping-cart text-gray-800 cursor-pointer hover:text-orange-500 hover:animate-pulse text-2xl group-hover:top-0 transition-all duration-300 left-1/4"
            aria-hidden="true"
