...
export default function Banner0() {
  return (
    <>
      ...
      >
        <SwiperSlide>
          <Banner0Carosul type='Electronics Items' img={Electronic} bg={'bg-yellow-200'}/>
        </SwiperSlide>
        <SwiperSlide>
          <Banner0Carosul type='Kitchen Items' img={Electronic} bg={'bg-orange-400'}/>
        </SwiperSlide> <SwiperSlide>
          <Banner0Carosul type='Electronics Goods' img={Electronic} bg={'bg-orange-200'}/>
        </SwiperSlide> <SwiperSlide>
          <Banner0Carosul type='Electronics Items' img={Electronic} bg={'bg-orange-300'}/>
        </SwiperSlide> <SwiperSlide>
          <Banner0Carosul type='Mobile Items' img={Electronic} bg={'bg-orange-400'}/>
        </SwiperSlide>
      </Swiper>
    </>
  );
