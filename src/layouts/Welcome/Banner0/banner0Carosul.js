...
const Banner0Carosul = (props) => {
  return (
    <div className={`p-10 py-20 grid grid-cols-1 sm:grid-cols-1 ${props?.bg} md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 pt-20  h-[30rem]`}>
      <div className="flex flex-col items-center justify-center order-2 sm:order-2 md:order-1 lg:order-1">
        <div className="space-y-3">
          ...
          <button className="p-1 px-5 text-white bg-gray-900 ">SHOP NOW</button>
        </div>
      </div>
