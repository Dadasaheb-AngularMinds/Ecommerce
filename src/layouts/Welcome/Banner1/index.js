...
const Banner1 = () => {
  ...
  return (
    <div className="bg-gray-900 container-fluid">
      ...
      <div className="relative px-6 py-20 overflow-hidden bg-gray-900 shadow-sm group sm:px-10 sm:py-24 md:px-12 lg:px-20">
        ...
        <div className="relative max-w-5xl mx-auto lg:mx-0">
          <div className="font-serif text-5xl font-bold text-orange-300">
            Blackwood - Clean Minimal eCommerce Site
          </div>
          {/* <span class="relative flex h-3 w-3">
            <span class="animate-ping absolute inline-flex h-full w-full rounded-full d-flex justify-center bg-orange-400 opacity-75"></span>
            <span class="relative inline-flex rounded-full h-6 w-full px-3 text-center d-flex justify-center bg-sky-500">
               <i class="bi bi-play-fill h-full  "></i>
            </span>
          </span> */}
          <figure>
