    ...
    <section id="todays-deals">
      <div className="relative p-5 bg-gray-800">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-4">
          <div className="group overflow-hidden bg-gray-200 relative p-4">
            <img
          ...
          <div className="grid bg-gray-100 p-4 gap-4">
            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 gap-7">
              <div className="group bg-gray-300 overflow-hidden p-0 relative">
                <img
                ...
                <div className="absolute top-0 left-0 grid w-full grid-cols-2 transition-all duration-500 bg-gray-800 opacity-0 group-hover:pt-1 sm:group-hover:pt-5 group-hover:bg-gray-800 group-hover:opacity-60 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
                  <div className="px-4">
                    <i
                      className="fa fa-bookmark top-2 ml-1 text-l sm:text-xl border px-1 sm:py-0 py-1 rounded text-gray-100"
                      aria-hidden="true"
                    ></i>
                    &nbsp; &nbsp; &nbsp;
                    <i
                      className="fa fa-share-alt top-2 ml-1 text-l sm:text-xl border px-1 sm:py-0 py-1 rounded text-gray-100"
                      aria-hidden="true"
                    ></i>
                  </div>
                ...
                <div className="absolute bottom-0 left-0 grid w-full grid-cols-2 transition-all duration-500 bg-gray-800 opacity-0 group-hover:pb-1 sm:group-hover:pb-5 group-hover:bg-gray-800 group-hover:opacity-60 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
                  <div className="px-4 pt-2">
                    <i
                      className="fa fa-heart-o top-2 ml-1 border px-1 py-1 sm:py-0 rounded sm:text-2xl text-l group-hover:opacity-90 hover:text-xl text-orange-600"
                      aria-hidden="true"
                    ></i>
                    &nbsp;&nbsp;&nbsp;
                    <i
                      className="fa fa-cart-plus top-2 ml-1 border px-1 py-1 sm:py-0 rounded text-l sm:text-2xl hover:text-xl text-gray-100"
                      aria-hidden="true"
                    ></i>
                  </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-7">
              <div className="group relative overflow-hidden p-0 bg-gray-300">
                <img
                ...
                <i
                  className="fa fa-plus text-4xl text-gray-100"
                  aria-hidden="true"
                ></i>
              </div> */}
