    ...
    <div className="bg-gray-900">
      ...
      <main className="relative isolate">
        ...
        <div className="px-6 pt-14 lg:px-8">
          <div className="max-w-full pt-24 mx-auto text-start sm:pt-40">
            <h2 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">
              "Shop the Latest Trends"
            </h2>
            <p className="mt-6 text-lg leading-8 text-gray-300">
              "Welcome to Ecommerce Site, your ultimate destination for fashion
              that reflects your unique style. Step into a world where trends
              come alive, and individuality is celebrated. At [Your Brand], we
              curate a collection of the latest fashion-forward pieces, designed
              to inspire and empower you. Discover an array of meticulously
              selected clothing, accessories, and more, all meticulously chosen
              to keep you ahead of the curve. Whether you're searching for
              timeless classics or bold statement pieces, our selection caters
              to all tastes and preferences. With a passion for quality and an
              eye for the latest trends, we're dedicated to providing you with a
              shopping experience that's both enjoyable and rewarding. Start
              your journey with us and explore a realm of possibilities in
              fashion. It's time to embrace the new and express your authentic
              self with [Your Brand]."
            </p>
            <button
              onClick={() => history('/user/dashboard')}
              className="mt-3 underline rounded text-sky-600 hover:text-sky-500 underline-offset-8"
              >
              -Continue shopping
            </button>
          </div>
